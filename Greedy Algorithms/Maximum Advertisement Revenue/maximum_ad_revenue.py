...
def max_dot_product(first_sequence, second_sequence):
    ...
    prices_sorted = sorted(first_sequence, reverse=True)
    clicks_sorted = sorted(second_sequence, reverse=True)
    return sum([i[0] * i[1] for i in zip(prices_sorted, clicks_sorted)])
